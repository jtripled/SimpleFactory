...
public class VoxenRegistry implements IGuiHandler
{
    ...
    {
        VoxenMod.REGISTRATION_HANDLER.onRegisterMessages(this);
    }
    ...
    public void onRegisterBlocks(IForgeRegistry<Block> registry)
    {
        ...
        VoxenMod.REGISTRATION_HANDLER.onRegisterBlocks(this);
