 ...
 * @author jtripled
 */
public class ContainerGratedHopper extends Container
{
    protected final TileGratedHopper tile;
    
    public ContainerGratedHopper(TileGratedHopper tile, InventoryPlayer playerInv)
    {
        this.tile = tile;
        for (int i = 0; i < 5; i++)
        {
